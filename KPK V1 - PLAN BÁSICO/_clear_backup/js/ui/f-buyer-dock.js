...
(function () {
  ...
  function _isBasicPlan() {
    try {
      if (window.KPK_PLAN === 'basic') return true;
      if (document.documentElement.getAttribute('data-kpk-plan') === 'basic') return true;
    } catch (e) {}
    return false;
  }
  ...
  function bind() {
    ...
    if (!_isBasicPlan() && !_nearbySearched && _origin()) {
      _nearbySearched = true;
